...
% 2013-02
% Traduzido e adaptado para o Portugues por Rui Figueiredo \copyright\ 2013
...
% e para 1 cm se usar formato A4.
% Se usar outro formato diferente, use 1 cm de margem por padr\~ao.
...
\begin{tabular}{@{}ll@{}}
\verb!\begin{chronology}{!\textit{texto}\verb!}! & Cronologia e Espaco Cronologico \\
\verb!\event{2014}{!\textit{texto}\verb!}!  & Evento. \\
\verb!\event{2016}{!\textit{texto}\verb!}!  & Evento. \\
\end{tabular}
                        
\begin{chronology}[5]{2010}{2018}{\textwidth}
\event{2014}{Evento1}
\event{2015}{Evento2}
\event{\decimaldate{25}{12}{2017}}{Evento3}
\end{chronology}                        
...
\verb!\=!  &   Define  tabula\c c\~ao. &
\verb!\>!  &   Vai para fim da tab.
\end{tabular}
...
\begin{table}[!th]
  ...
  \label{ex:tabela}
\end{table}
nbnA tabela 'e numerada \ref{ex:tabela}.
\end{document}
\end{verbatim}
...
Copyright \copyright\ 2013 Rui Figueiredo
http://ruifigueiredo.me/
